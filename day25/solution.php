...
$comparisons = 0; while(true){
    ...
    printf("comparisons so far: %10d | nConstelations: %10d \n", $comparisons, $nc);
    for($i=0;$i<$nc;$i++){
...
/////////////////////////////////////////////////////////////////////
function point2string(array $p){ return ve($p); }
...
function _canConstelationsMerge(array $c1, array $c2){ foreach($c1 as $p1) if(pointInConstelation($p1, $c2)) return true; return false; }
function pointInConstelation(array $p, array $c){ if(count($c)===0) return true; foreach($c as $cp) if(manh($p,$cp)<=3) return true; }
