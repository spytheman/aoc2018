...
[Day 18: Settlers of The North Pole](https://adventofcode.com/2018/day/18) | [day18/solution.php](day18/solution.php) | Bruteforcing for part 2 was waaayy too slow (~25ms/1 simulated minute => > 289 realtime waiting :-( ). The grids does seem to repeat ... So the main optimization was to find the cycle of repetition first, then use it to predict the future grid.
